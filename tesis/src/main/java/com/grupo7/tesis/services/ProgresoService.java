...
public class ProgresoService {
    ...
    public Progreso obtenerResumenAcademico(List<MateriaDTO> materiasCursadas, List<MateriaDTO> cursosElectivas,
        ...
        for (MateriaDTO m : materiasCursadas) {
            ...
            if (m.getTipo() != null && m.getTipo().equalsIgnoreCase("Si") && cred != null && esNumero(cred)
        ...
        int creditosEnfasis = Stream
                .of(cursosEnfasis, cursosSeguridad, cursosIA, tablaDesarrolloComputacion, tablaDesarrolloGestion,
        ...
        int creditosExtra = creditosElectivaExtra + creditosComplementariaExtra + creditosEnfasisExtra
                + creditosElectivaBasicasExtra + creditosPerdidos;

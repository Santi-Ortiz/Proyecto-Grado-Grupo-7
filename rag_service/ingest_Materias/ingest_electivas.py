...
# ===== Configuración =====
PDF_PATH = "../data/Electivas/Materias_Electivas.pdf"
OUT_DIR = "faiss_electivas"        # Cambia a faiss_enfasis / faiss_electivas / faiss_materias según corresponda
TIPO = "electivas"                 # "enfasis" | "electivas" | "complementarias" | "todas"

...
# ===== Configuración =====
PDF_PATH = "../data/Materias_Sin_Filtro/Materias_Sin_Filtro.pdf"
OUT_DIR = "faiss_materias"        # Cambia a faiss_enfasis / faiss_electivas / faiss_materias según corresponda
TIPO = "cualquiera"                 # "enfasis" | "electivas" | "complementarias" | "todas"
